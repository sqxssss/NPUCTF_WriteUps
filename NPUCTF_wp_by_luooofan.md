...
- ida打开分析
  ...
  ![image-20200422234230103](https://github.com/Luoofan/Images/blob/master/NPUCTFWP/image-20200422234230103.png)
...
- 疯狂明示的shellcode：（关键部分用它就可`shellcode=asm(shellcraft.sh())`）
  ...
  - 返回地址这里要控制程序返回到rsp，以便执行下一条指令，即这里填充`p64(0x40064b)`
    ...
    ![image-20200422235451627](https://github.com/Luoofan/Images/blob/master/NPUCTFWP/image-20200422235451627.png)
...
- 首先`checksec`
  ...
  ![image-20200422204504696](https://github.com/Luoofan/Images/blob/master/NPUCTFWP/image-20200422204504696.png)

  开启了`NX堆栈不可执行`，`PIE地址随机化`，还有`Full RELRO`，无法修改got表，没有开`canary`保护

- ida打开分析

  ![image-20200422210644228](https://github.com/Luoofan/Images/blob/master/NPUCTFWP/image-20200422210644228.png)
...
- ![image-20200422214432013](https://github.com/Luoofan/Images/blob/master/NPUCTFWP/image-20200422214432013.png)
...
- 但是我们不仅要读出来还要写进去啊，来看栈结构：
  ...
  ![stack](https://github.com/Luoofan/Images/blob/master/NPUCTFWP/TIM图片20200422220839.png)
